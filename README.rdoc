...
3. Create a config/assets.yml file that looks something like this:
   ...
   The asset file sets some config values and then lists your assets. Don't be shy
...
=== Set assets to be combined, even in development
...
=== Or, to eliminate the biggest bottleneck, turn off class caching in dev
...
Copyright (c) 2011 Robert Davis. See LICENSE.txt for further details.
